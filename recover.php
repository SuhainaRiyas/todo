...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      <h4 class="login-box-msg">Forgot your password</h4>
</div>
      <form action="action.php" method="post" id="loginform">
        ...
        <div class="row">
          ...
          <div class="col-md-12 col-sm-12">
            <button type="submit" class="btn btn-sm btn-success btn-block" name="login" id="loginbtn">Set new password</button>
          </div>
          <!-- /.col -->
        </div>
...
<script>
  $("#loginbtn").click(function(e){
        ...
        if(email == '' || password == '' || cpass ==''){
  		...
  		$.ajax({
            data : {email:email,password:password,cpass:cpass,action:'passwordChange'},
            type: "post",
			      url: "action.php",
